...
impl JpegDecoder {
    ...
    fn ycbcr_to_rgb(y: i32, cb: i32, cr: i32) -> (u8, u8, u8) {
        // Standard JFIF YCbCr to RGB conversion
    ...
    /// Install default Huffman tables (standard JPEG luminance/chrominance)
    fn install_default_huffman_tables(&mut self) {
        ...
        self.huffman_ac_tables[0] = Some(HuffmanTable {
            ...
            values: (0..162).collect(), // Full AC table values
        });
